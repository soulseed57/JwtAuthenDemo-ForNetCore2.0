...
namespace Authen.Jwt.Api.Issuer.Service
{
    ...
    public static class JsonWebTokenService
    {
        ...
        static readonly Dictionary<JwtHashAlgorithm, Func<byte[], byte[], byte[]>> HashAlgorithms;
        ...
        static JwtHashAlgorithm GetHashAlgorithm(string algorithm)
        {
            switch (algorithm)
            {
        ...
        public static string Encode(object payload, byte[] keyBytes, JwtHashAlgorithm algorithm)
        {
            ...
            //    iat = 1328550785
            //};
            //var jsonStr = JsonConvert.SerializeObject(jsonSrc);
            //var payloadBytes = Encoding.UTF8.GetBytes(jsonStr);
